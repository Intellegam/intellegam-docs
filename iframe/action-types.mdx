...
**Parameters:**
- `type` (string) - Must be `"intellegam:host-control"`
- `action` (string) - Must be `"send"`
- `parts` (Array&lt;TextPart | FilePart&gt;) - Must include exactly one text part, optionally 0-5 images
...
**Parameters:**
- `type` (string) - Must be `"intellegam:host-control"`
- `action` (string) - Must be `"append-attachments"`
- `parts` (Array&lt;FilePart&gt;) - 1-5 image files required, text parts are ignored
